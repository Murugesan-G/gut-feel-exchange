<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master_Pages/Master.Master" Title="Monthly Subscription Report" CodeBehind="MonthlySubscriptionReport.aspx.cs" Inherits="NTCYApplication.Reports.ASPX.MonthlySubscriptionReport" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 page-title-outer">
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 page-title">Subscription Bills Report</div>
